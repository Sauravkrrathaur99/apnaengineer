    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.IntegerField(default=None, max_length=10)),
                ('type', models.CharField(choices=[('CUSTOMER', 'CUSTOMER'), ('ENGINEER', 'ENGINEER')], default='Please Select from Dropdown', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Mechanic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_no', models.PositiveIntegerField()),
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='device.customer')),
                ('mechanic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='device.mechanic')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
